...
- Массовая генерация документов (Word и Excel) из Excel и Word шаблонов
...
- Формирование общего PDF документа на основе Word, PDF и/или изображения с возможностью визуального редактирвоания
- Экспорт информации из Word и PDF в Excel
- Нумерация страниц, с возможность вариативности
- Редактор PDF, Excel и изображений
- Препросмотр документов
- Логирование действий
- Конструктор Excel файлов для полного соответствия заложенным плейсхолдерам
- Многопоточная обработка с настраиваемым количеством процессов
- Оптимизация производительности, фоновая загрузка окружения (без интерент-соединения)
- Работа с несколькими задачами через систему вкладок
- Сохранение и загрузка пресетов формирования документов, конструктора Excel и нумерации документов
...
```bash
pip install pandas openpyxl python-docx pymorphy3 customtkinter pypdf pdfplumber
